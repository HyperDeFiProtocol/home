export default {
  ...
  freeForTaker: '索取者费用免除',
  freeForMaker: '贡献者费用免除',
  freeForWhale: '鲸鱼费用免除',
  ...
  scriptWarning: '脚本警告',
  scriptNotWelcomed__moreThan: 'HyperDeFi 生态不欢迎脚本机器人，尤其是在早期阶段。如果有人使用脚本进行大额交易大于流动性的',
  scriptCannot__: '（这是手动无法做到的），他将被当作掠食者对待，征收高达',
  scriptOfTheTax: '的交易费用（',
  script4Farm_: '进入税收矿池，',
  script4Airdrop_: '随机发放空投，',
