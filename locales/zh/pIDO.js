export default {
  ...
  endTime_: '结束时间或总存入上限：',
  or: '或',
  nowTheLastDeposit: '现在，允许最后一笔存入；PancakeSwap 流动池将在存入完成同时建立。',

  countdown: '倒计时',
  startCountdown: '开始倒计时',
  endCountdown: '结束倒计时',
  closing: '近完成',
  waitForTheLastDeposit: '等待最后一笔存入',
  finished: '已结束',
  initialLiquidityCreated: '初始流动池已建立',
  depositedBNBAmount: '已收到的 BNB 总量',

  connectWalletToDeposit: '连接钱包 参与创世存入',
  ...
  // add liquidity
  createLiquidity1: '铸币总量上限的',
  createLiquidity2: '，',
  createLiquidity3: '并与以上所有存入的 BNB 一并创建 PancakeSwap 初始流动池。',
  liquidityCreatedAt: 'PancakeSwap 初始流动池已创建于：',

  createLi1__: '团队无权占有创世 IDO 存入的 BNB',
  createLi2__: '所有流程由合约自动执行，人工无法介入',

  // redeem
  redeemTitle: '参与了创世的用户，按比例认领 HyperDeFi',
  yourPortion: '您的份额：',
  notRedeemed: '（尚未认领）',
  redeemed: '（已认领）',
